...
public final class BlazeJarLibrary extends BlazeLibrary {
   ...
   */
  class BlazeJarLibraryModelModifier implements BlazeLibraryModelModifier {
    ...
    BlazeJarLibraryModelModifier(
      ...
      this.libraryName = key.getIntelliJLibraryName();
    }
    ...
    public boolean equals(Object other) {
      ...
      return super.equals(other)
          && java.util.Objects.equals(this.project, that.project)
          && this.libraryModel.equals(that.libraryModel)
          && java.util.Objects.equals(this.libraryName, that.libraryName);
    }

    @Override
    public int hashCode() {
      return java.util.Objects.hash(project, libraryModel, libraryName);
    }
  }
}
