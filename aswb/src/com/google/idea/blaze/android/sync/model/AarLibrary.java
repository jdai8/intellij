...
public final class AarLibrary extends BlazeLibrary {
  ...
  /** An implementation of {@link BlazeLibraryModelModifier} delegating to {@link AarLibrary} */
  public class AarLibraryModelModifier implements BlazeLibraryModelModifier {
    ...
    public boolean equals(Object other) {
      ...
      return super.equals(other)
          ...
          && Objects.equals(this.libraryName, that.libraryName);
    }

    @Override
    public int hashCode() {
      return Objects.hash(project, libraryModel, libraryName);
    }
  }
}
