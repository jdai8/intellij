...
public final class AarLibrary extends BlazeLibrary {
  ...
  public BlazeLibraryModelModifier toModifier(ModifiableModel modifiableModel) {
    return new AarLibraryModelModifier(modifiableModel);
  }
  ...
  public class AarLibraryModelModifier extends BlazeLibraryModelModifier {

    AarLibraryModelModifier(ModifiableModel modifiableModel) {
