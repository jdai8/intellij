...
public class BlazeAndroidLaunchTasksProvider implements LaunchTasksProvider {
  ...
  @Nullable
  private <State extends AndroidDebuggerState> ConnectDebuggerTask getConnectDebuggerTask(
      @NotNull LaunchStatus launchStatus,
      @NotNull AndroidDebugger<State> debugger,
      @NotNull State debuggerState) {
    try {
