...
public abstract class BlazeLibraryModelModifier {
  protected final Library.ModifiableModel libraryModel;
  public final String libraryName;

  public BlazeLibraryModelModifier(String libraryName, Library.ModifiableModel libraryModel) {
    this.libraryModel = libraryModel;
    this.libraryName = libraryName;
  }

  protected void removeAllContents() {
  ...
  public abstract void refreshLibraryModelContent(
      Project project, ArtifactLocationDecoder artifactLocationDecoder);

  protected String pathToUrl(File path) {
